...
// 🔥 2. ACTIVAMOS CORS PARA EXPRESS (Permite a Netlify conectarse)
app.use(cors({
    origin: "*" 
}));
...
// 🔥 3. ACTIVAMOS CORS PARA SOCKET.IO (Permite la transmisión en vivo a Netlify)
...
// Servir archivos del frontend (por si los necesitas localmente)
